...
if (
    ...
    if ($idEval->rowCount() > 0 && $idMatie->rowCount() > 0) {
        ...
        $stmt = $PDO->query("UPDATE note SET NoteEtudiant='$note' WHERE numcarte='$numCard' and idEvaluation='$IdE' and IdMatiere='$IdM' ");
...
<body>
    ...
    <section class="home-section">
        ...
        <div class="home-content">
            <div class="container">
                <div class="text">Modifier une Note </div>
                <form method="POST">
                    <div class="form-row">
                        <div class="input-data">
                            <input type="text" name="note" required>
                            <div class="underline"></div>
                            <label for="">Nouvelle note de l'Etudiant</label>
                        </div>
